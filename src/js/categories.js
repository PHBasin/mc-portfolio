const categoriesData = [
    {
        id: 'voisins-originaux',
        title: "Des voisins, pour le moins originaux…",
        cover: "assets/gallery/voisins-originaux/cover.webp",
        description: [
            "À la tombée du jour, tandis que les humains se réfugient dans leurs foyers, une autre vie s'éveille, discrète et insaisissable. Loin de l'agitation diurne, certains animaux fuient les lumières de la ville, tandis que d'autres, plus opportunistes, s'adaptent et tirent profit de notre présence. Parmi eux, le renard et la fouine, maîtres de l'ombre, arpentent silencieusement les ruelles et les abords des routes, à la recherche d'une opportunité, d'un repas laissé derrière nous.",
            "Leur présence est presque imperceptible, comme des esprits errants glissant dans la nuit. Rien ne les trahit, si ce n'est, parfois, une silhouette fugace qui surgit sous les phares d'une voiture avant de s'évanouir dans l'obscurité. Ici, la ville et la nature s'entrelacent dans une danse nocturne méconnue.",
            "Les lampadaires, ces « mini soleils » érigés par l'homme, projettent leur lueur artificielle sur ce monde secret. Ils deviennent mes alliés, révélant, le temps d'un instant, ces êtres fascinants et souvent incompris. Grâce à eux, j'observe et capture ces rencontres furtives, témoignant d'une nature qui s'adapte, résiste et coexiste dans un univers que nous croyons nôtre."
        ]
    },
    {
        id: 'belle-region',
    ...
    {
        id: 'chant-automne',
        title: "Le chant de l'automne",
        cover: "assets/gallery/chant-automne/cover.webp",
        description: [
    ...
    {
        id: 'vase-cou',
        title: "De la vase jusqu'au cou",
        cover: "assets/gallery/vase-cou/cover.webp",
        description: [
            "Tandis que la nuit résiste encore aux premiers feux du jour, je m'avance silencieusement jusqu'à la berge d'un petit étang que je connais si bien. Dans mon affût flottant, je me laisse porter par l'eau calme, attendant, immobile à moitié dans la vase. Arrivé au cœur de cet écrin aquatique, il ne me reste plus qu'à patienter, espérant que l'aube dévoilera les âmes discrètes de ce lieu secret.",
            "Le chant des oiseaux réveille doucement la matinée, tandis que, soudain, le sifflement aigu du martin-pêcheur perce l'air. Une flèche d'un bleu éclatant traverse l'étang avant de se poser, parfois, sur l'affût, m'offrant un instant de complicité avec ce messager des rives. Peu après, mon regard se pose sur le reflet argenté d'un grand cormoran tournoyant, léger, au-dessus de l'eau. Son atterrissage, lourd et bruyant, annonce une matinée riche en photos.",
            "De temps en temps, les oies bernaches glissent autour de l'affût flottant, comme une danse silencieuse, en parfaite harmonie avec la quiétude de l'étang. Puis, alors que le soleil commence à caresser l'horizon, sa lumière douce et dorée se répand sur l'eau, illuminant les bécassines qui, avec grâce, se lancent dans une danse caractéristique, telle une mélodie de la nature.",
            "Et quand le jour se retire, un renard solitaire traverse, furtif, la rivière, baigné dans la lueur des derniers rayons du soleil, comme une ombre passant sous l'œil attentif de ma lentille."
        ]
    },
    {
        id: 'odeur-foin',
        title: "L'odeur du foin",
        cover: "assets/gallery/odeur-foin/cover.webp",
        description: [
            "À la fin du printemps, la nature atteint son apogée. Débarrassée des gilets orange, des coups de cor et des aboiements qui résonnaient encore en hiver, elle a repris son souffle et donné naissance à une nouvelle génération. Mais soudain, un autre son envahit la campagne : celui des faucheuses. L'heure du foin a sonné !",
            "Les champs, hier encore ondulants sous le vent, deviennent un vaste terrain dévoilé, baigné d'une atmosphère unique, presque irréelle. Il faut l'avoir vécu pour le comprendre. Aux premières lueurs du matin, les opportunistes entrent en scène. Les renards, comme ivres de cette abondance soudaine, sillonnent les prairies à la recherche des campagnols pris au piège, désormais livrés à la lumière du jour, dépourvus de l'abri que l'herbe leur procurait. Plus loin, les cervidés s'avancent prudemment, savourant l'herbe coupée au parfum encore humide de la nuit.",
            "Et parfois, avec une chance infinie, l'ombre furtive d'une martre ou la silhouette massive d'un sanglier apparaît à la lisière du bois.",
            "Dans les rares coins épargnés par la chasse, le spectacle est saisissant : il n'est pas rare d'apercevoir plusieurs renards en une seule matinée, insouciants, profitant de cette parenthèse éphémère où l'équilibre de la nature se redessine.",
            "C'est avec une nostalgie mêlée d'excitation que, dès le premier matin après la fauche, je me glisse dans ces champs, rampant au sol, attentif au moindre mouvement. Ici, chaque bruissement d'herbe, chaque lueur dorée du soleil levant raconte une histoire. Observer ce ballet discret, sentir le pouls de la nature s'adapter à ce bouleversement, est un privilège rare, un instant suspendu entre fragilité et émerveillement."
        ]
    },
    {
        id: 'rer-nard',
    ...
    },
    {
        ...
        description: [
            "L'hiver est l'occasion de s'évader en montagne, de profiter des joies des sports d'hiver. Mais derrière cette effervescence humaine, la nature, elle, traverse une saison rude. Alors que le froid et la neige compliquent déjà la survie de nombreux animaux, les stations résonnent du bruit des remontées mécaniques et du passage incessant des skieurs. La faune, discrète et oppressée tout au long de la journée, ne laisse souvent que quelques indices de sa présence : des empreintes éphémères sur le manteau blanc.",
            "Mais lorsque le dernier télésiège s'immobilise, que les tire-fesses s'arrêtent et que les cabines effectuent leur ultime ascension, un autre monde s'éveille. À la fermeture des pistes, alors que les pisteurs font leur dernière descente, la montagne respire à nouveau. Comme s'ils possédaient une montre secrète, les animaux sortent de l'ombre. Les pentes fraîchement damées deviennent alors le terrain de jeu des renards, chevreuils et autres habitants des cimes.",
...
document.addEventListener('alpine:init', () => {
    Alpine.data('portfolio', () => ({
        ...
        catId: new URLSearchParams(window.location.search).get('id'),
        get category() {
            return this.categories.find(c => c.id === this.catId);
        }
    }));
});
